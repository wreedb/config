...
ble-face -s region_match        fg=green
ble-face -s region_target       fg=cyan
ble-face -s disabled            fg=242
ble-face -s overwrite_mode      reverse
...
ble-face -s syntax_glob               fg=red
ble-face -s syntax_brace              fg=cyan,bold
ble-face -s syntax_tilde              fg=magenta,bold
...
ble-face -s command_keyword           fg=cyan
#ble-face -s command_jobs              fg=red,bold
ble-face -s command_directory         fg=red,underline
ble-face -s command_suffix            fg=black
ble-face -s command_suffix_new        fg=black
...
ble-face -s filename_link             fg=blue
...
ble-face -s filename_executable       underline,fg=green,bold
...
ble-face -s filename_warning          underline,fg=red,bold
ble-face -s filename_url              underline,fg=blue,bold
#ble-face -s filename_ls_colors        underline
ble-face -s varname_array             fg=yellow,bold
ble-face -s varname_empty             fg=242
ble-face -s varname_export            fg=red,bold
ble-face -s varname_expr              fg=magenta,bold
ble-face -s varname_hash              fg=green,bold
ble-face -s varname_new               fg=green,bold
ble-face -s varname_number            fg=cyan,bold
ble-face -s varname_readonly          fg=black,bg=red,bold
ble-face -s varname_transform         fg=green,bold
ble-face -s varname_unset             fg=242

ble-face -s menu_complete_match         bold,fg=green
ble-face -s menu_complete_selected      fg=green,underline,bold
ble-face -s auto_complete               fg=242
ble-face -s cmdinfo_cd_cdpath           fg=yellow,bold
